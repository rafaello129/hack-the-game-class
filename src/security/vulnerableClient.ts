...
// Todo el JavaScript enviado al navegador puede inspeccionarse.
export const DEMO_ADMIN_CODE = 'dragon123';

// Error 2: tratamos datos del navegador como si fueran confiables.
...
export function saveClientProgress(score: number, lives: number): void {
  window.localStorage.setItem(SCORE_KEY, String(score));
  window.localStorage.setItem(LIVES_KEY, String(lives));
}

// Error 3: una autorización importante se decide completamente en frontend.
// El usuario controla tanto la URL como localStorage.
