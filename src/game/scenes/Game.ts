...
export class Game extends Scene
{
    ...
    create ()
    {
        this.coins = [];
        this.enemies = [];
        // Esta rama no confía en localStorage como fuente autoritativa.
        // Puntuación y vidas nacen de las reglas de la partida actual.
        this.score = 0;
    ...
    private createHud ()
    {
        ...
        this.add.text(48, 35, 'HACK THE GAME · SEGURO', {
